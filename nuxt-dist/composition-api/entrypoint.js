...
const isFullStatic = "false".includes("options") ? false : JSON.parse("false");
...
const staticPath = "/Users/omer/Desktop/Projects/PickansFE/pickansUI/nuxt-dist/static-json";
const staticCache = {};
...
const useStatic = (factory, param = CompositionApi.ref(""), keyBase) => {
  ...
  if (process.client) {
    const publicPath = ((_b = (_a = window[globalContext].$config) == null ? void 0 : _a.app) == null ? void 0 : _b.cdnURL) || "/";
...
exports.defineNuxtConfig = defineNuxtConfig;
