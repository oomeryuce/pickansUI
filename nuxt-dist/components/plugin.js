...
const components = {
  DarkModeButton: () => import('../../components/DarkModeButton.vue' /* webpackChunkName: "components/dark-mode-button" */).then(c => wrapFunctional(c.default || c)),
  FeedHeader: () => import('../../components/FeedHeader.vue' /* webpackChunkName: "components/feed-header" */).then(c => wrapFunctional(c.default || c)),
  FeedRank: () => import('../../components/FeedRank.vue' /* webpackChunkName: "components/feed-rank" */).then(c => wrapFunctional(c.default || c)),
  FetchState: () => import('../../components/FetchState.vue' /* webpackChunkName: "components/fetch-state" */).then(c => wrapFunctional(c.default || c)),
  FollowTags: () => import('../../components/FollowTags.vue' /* webpackChunkName: "components/follow-tags" */).then(c => wrapFunctional(c.default || c)),
  ...
  PageHeaderOld: () => import('../../components/PageHeaderOld.vue' /* webpackChunkName: "components/page-header-old" */).then(c => wrapFunctional(c.default || c)),
  ...
  ProfileInfo: () => import('../../components/Profile/ProfileInfo.vue' /* webpackChunkName: "components/profile-info" */).then(c => wrapFunctional(c.default || c)),
  ProfileSkills: () => import('../../components/Profile/ProfileSkills.vue' /* webpackChunkName: "components/profile-skills" */).then(c => wrapFunctional(c.default || c)),
  ProfileTemplate: () => import('../../components/Profile/ProfileTemplate.vue' /* webpackChunkName: "components/profile-template" */).then(c => wrapFunctional(c.default || c)),
  ProfileUserCard: () => import('../../components/Profile/UserCard.vue' /* webpackChunkName: "components/profile-user-card" */).then(c => wrapFunctional(c.default || c)),
