  ...
  >
    ...
    <div
      class="
        ...
        justify-between
        h-full
        md:py-0 md:border-b-0 md:overflow-hiden md:h-full md:flex-col md:py-5
      "
    >
      <div class="fixed flex flex-col h-full justify-between w-36">
        <!-- Input and SVG -->
        <div
          class="
            flex flex-row
    ...
    <!-- Mobile Menu -->
    <div class="flex sm:flex md:flex lg:hidden xl:hidden">
      <div class="w-full grid grid-cols-12 gap-2 pt-3 pb-3 md:pb-0">
        <div class="col-span-4 relative sm:max-w-xl z-50">
        ...
        <n-link to="/" class="col-span-4 mx-auto z-50 justify-center">
          <img
            class="h-12"
            src="~/static/img/pickans_beta_logo.png"
            alt="Pickans | Knowledge Sharing Platform"
