  ...
  <div class="container mx-auto">
    ...
    >
      ...
      <div
        ...
        "
      >
        <div class="px-10 py-8 lg:w-3/4 lg:mx-auto lg:px-12 lg:py-12">
          <div
            class="
              mb-8
              text-theme-base-900
          ...
          <div class="flex flex-row flex-wrap items-center mb-5">
            ...
            <transition name="fade" mode="out-in">
              <div
                v-if="checkLogin && checkLogin.loginType[0] === 'password'"
                class="flex flex-row flex-wrap items-center mb-5 w-full"
              >
                <input
              ...
              <div
                v-if="checkLogin && !checkLogin.exist"
                class="flex flex-row flex-wrap items-center mb-5 w-full"
              >
                <input
            ...
            <button
              type="button"
              class="btn btn-primary font-bold capitalize text-lg"
              :disabled="loading"
              @click="submit"
            >
              <svg
          ...
          <div class="grid grid-cols-2 gap-4 flex-wrap items-center">
            <div class="col-span-2 md:col-span-1">
              <button
                ...
                class="
                  btn btn-outline
                  w-full
                  hover:bg-github hover:text-white
                  btn-lg
                  capitalize
                "
                :disabled="loading"
            ...
            <div class="col-span-2 md:col-span-1">
              <button
                id="google"
                type="button"
                class="btn btn-outline btn-lg w-full capitalize"
                :disabled="loading"
            ...
            <div class="col-span-2 md:col-span-1">
              <button
                ...
                class="
                  ...
                  w-full
                  hover:bg-fb-variant hover:text-white
                  capitalize
                "
                :disabled="loading"
            ...
            <div class="col-span-2 md:col-span-1">
              <button
                ...
                class="
                  btn btn-outline btn-lg
                  w-full
                  hover:bg-lnkin-variant hover:text-white
                  capitalize
                "
                :disabled="loading"
              >
...
export default defineComponent({
  ...
  watch: {
    ...
    isEmailExist(newValue, oldValue) {
      if (newValue !== oldValue) {
        this.checkLogin = newValue;
        if (newValue.exist && newValue.loginType[0] === "google.com") {
          this.clearAlerts();
  ...
  methods: {
    ...
    async checkEmail() {
      await this.emailCheck({ email: this.loginData.email });
    },
    ...
    async submit() {
      ...
      if (!checkData) {
        ...
        checkData &&
        checkData.exist &&
        checkData.loginType[0] === "password"
      ) {
